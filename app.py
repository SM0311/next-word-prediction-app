...
st.write("This app uses an LSTM model to predict the next word in a sentence. Simply enter a sequence of words, and let the model predict the next likely word!")
